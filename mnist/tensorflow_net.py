...
class NET:
    def __init__(self):
        ...
        self.W_conv1 = tf.get_variable(xavier_init_conv2d([5,5,1,32]))
        ...
        self.offset_conv1 = tf.get_variable(tf.zeros([32]))
        self.scale_conv1 = tf.get_variable(tf.ones([32]))
        ...
        self.W_conv2 = tf.get_variable(xavier_init_conv2d([5,5,32,64]))
        ...
        self.offset_conv2 = tf.get_variable(tf.zeros([64]))
        self.scale_conv2 = tf.get_variable(tf.ones([64]))
        ...
        # fc1  #[BS,3136]->[BS,1024]
        self.W_fc1 = tf.get_variable(xavier_init([7 * 7 * 64, 1024]))
        ...
        self.offset_fc1 = tf.get_variable(tf.zeros([1024]))
        self.scale_fc1 = tf.get_variable(tf.ones([1024]))
        ...
        # fc2  #[BS,1024]->[BS,10]
        self.W_fc2 = tf.get_variable(xavier_init([1024, 10]))
        ...
        self.offset_fc2 = tf.get_variable(tf.zeros([10]))
        self.scale_fc2 = tf.get_variable(tf.ones([10]))
